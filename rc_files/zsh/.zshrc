...
emacs-backward-delete-word () {
    local WORDCHARS="${WORDCHARS:s#/#}"
    zle backward-delete-word
}

zle -N backward-kill-word emacs-backward-delete-word

zstyle ':completion:*' menu select=5 search
...
source ${ZDOTDIR:-$HOME}/.zkbd/xterm-256color-unknown-linux-gnu
...
source /usr/share/zsh/plugins/fasd/fasd.plugin.zsh
...
# parrot
alias arm-gdb='/opt/arm-2012.03/bin/arm-none-linux-gnueabi-gdb'
autoload bashcompinit
bashcompinit
source /etc/bash_completion.d/parrot_dragon1plus_build
alias mag='emacsclient -nw --eval "(progn (magit-status)(delete-other-windows))"'
source $HOME/git/parrot_utils.sh
